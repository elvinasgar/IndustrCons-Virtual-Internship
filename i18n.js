/**
 * IndustrCons IRE-3 — i18n engine
 * Usage in HTML:
 *   <span data-i18n="hero.title"></span>
 *   <input data-i18n-placeholder="catalog.searchPlaceholder">
 *   <img data-i18n-alt="...">
 * JS:
 *   await IC.i18n.init();          // call once per page
 *   IC.i18n.t('hero.title');       // read a string
 *   IC.i18n.setLanguage('az');     // switch instantly
 */
window.IC = window.IC || {};
...
IC.i18n = (function () {
  ...
  function resolveBasePath() {
    // Works whether page is at root or one level deep (e.g. /internship-detail.html)
